...
// publish messages if publisher
		if (publisher) {
			while (true) {
				String pubMsg = "This is my message to everyone listening right now. Spent ten hours on this flight, told the pilot there aint no flight plans. I dont know when I land.";
				int pubQoS = 0;
